...
void registrarInasistencias(
  ...
  if (documentos.contains(documento)) {
    ...
    stdout.write(
        "El aprendiz ya está registrado. Ingrese la cantidad de inasistencias actualizada: ");
...
void listarInasistenciasSuperioresA3(
    List<String> documentos, List<String> nombres, List<int> inasistencias) {
...
void consultarTotalInasistenciasPorAprendiz(
  ...
  if (indice != -1) {
    print(
        "Documento: ${documentos[indice]}, Nombre: ${nombres[indice]}, Inasistencias: ${inasistencias[indice]}");
  } else {
    print(
        "El documento ingresado no corresponde a ningún aprendiz registrado.");
  }
}
